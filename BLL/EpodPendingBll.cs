...
{
    public class EpodPendingBll
    {
        private readonly DataDbContext _context;
        private readonly IHostEnvironment _env;
        private readonly ShipmentBll _spcontext;
        public EpodPendingBll(DataDbContext context, StoredProcedureDbContext spcontext, IHostEnvironment env)
        {
            _context = context;
        ...
        public async Task<List<Shipment>> GetEpodPendingList()
        {
